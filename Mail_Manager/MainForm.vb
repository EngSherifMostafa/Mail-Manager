...
Public Class MainForm
    ...
    Function initCommands()
        ...
        AidFunctions.clearTextboxs(findUserNameTb, findPasswordTb, findWebsiteTb, findLinkTb)
        AidFunctions.clearTextboxs(addUserNameTb, addPasswordTb, addWebsiteTb, addLinkTb)
        AidFunctions.clearTextboxs(editUserNameTb, editPasswordTb, editWebsiteTb, editLinkTb)
        AidFunctions.clearTextboxs(delUserNameTb, delPasswordTb, delWebsiteTb, delLinkTb)
        AidFunctions.clearTextboxs(sendFromTb, sendSubjectTb, sendToTb, sendAttFileNameTb)
    End Function

    'refill listboxs
    Function refillListbox()
        Try
            AidFunctions.fillListBox(dataTblWebsite, findAccLb, "websiteName")
            AidFunctions.fillListBox(dataTblWebsite, editAccLb, "websiteName")
            AidFunctions.fillListBox(dataTblWebsite, delAccLb, "websiteName")
    ...
    Private Sub findShwPassCb_CheckedChanged(sender As Object, e As EventArgs) Handles findShwPassCb.CheckedChanged
        AidFunctions.showPasswordCb(findShwPassCb, findPasswordTb)
    End Sub
    ...
    Private Sub byUserRb_CheckedChanged(sender As Object, e As EventArgs) Handles findByUserRb.CheckedChanged
        Try
            AidFunctions.fillListBox(dataTblUserName, findAccLb, "userName")
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub findDgv_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles findDgv.RowEnter
        findUserNameTb.Text = AidFunctions.getSelectedFromDgv(findDgv, e, 0)
        findPasswordTb.Text = AidFunctions.getSelectedFromDgv(findDgv, e, 1)
        findWebsiteTb.Text = AidFunctions.getSelectedFromDgv(findDgv, e, 2)
        findLinkTb.Text = AidFunctions.getSelectedFromDgv(findDgv, e, 3)
    End Sub

    'copy buttons
    Private Sub findUserCpyBtn_Click(sender As Object, e As EventArgs) Handles findUserCpyBtn.Click
        AidFunctions.copyBtn(findUserNameTb)
    End Sub

    Private Sub findPassCpyBtn_Click(sender As Object, e As EventArgs) Handles findPassCpyBtn.Click
        AidFunctions.copyBtn(findPasswordTb)
    End Sub

    Private Sub findWebCpyBtn_Click(sender As Object, e As EventArgs) Handles findWebCpyBtn.Click
        AidFunctions.copyBtn(findWebsiteTb)
    End Sub

    Private Sub findLinkCpyBtn_Click(sender As Object, e As EventArgs) Handles findLinkCpyBtn.Click
        AidFunctions.copyBtn(findLinkTb)
    End Sub
    ...
    Private Sub addShwPassCb_CheckedChanged(sender As Object, e As EventArgs) Handles addShwPassCb.CheckedChanged
        AidFunctions.showPasswordCb(addShwPassCb, addPasswordTb)
    End Sub
    ...
    Private Sub genPassBtn_Click(sender As Object, e As EventArgs) Handles genPassBtn.Click
        ...
        addPasswordTb.Text = AidFunctions.genRandPass(passlen, chSet)
    End Sub
    ...
    Private Sub addClrBtn_Click(sender As Object, e As EventArgs) Handles addClrBtn.Click
        AidFunctions.clearTextboxs(addUserNameTb, addPasswordTb, addLinkTb, addWebsiteTb)
    End Sub
    ...
    Private Sub editShwPassCb_CheckedChanged(sender As Object, e As EventArgs) Handles editShwPassCb.CheckedChanged
        AidFunctions.showPasswordCb(editShwPassCb, editPasswordTb)
    End Sub
    ...
    Private Sub editByUserRb_CheckedChanged(sender As Object, e As EventArgs) Handles editByUserRb.CheckedChanged
        Try
            AidFunctions.fillListBox(dataTblUserName, editAccLb, "userName")
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub editDgv_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles editDgv.RowEnter
        editUserNameTb.Text = AidFunctions.getSelectedFromDgv(editDgv, e, 1)
        editPasswordTb.Text = AidFunctions.getSelectedFromDgv(editDgv, e, 2)
        editWebsiteTb.Text = AidFunctions.getSelectedFromDgv(editDgv, e, 3)
        editLinkTb.Text = AidFunctions.getSelectedFromDgv(editDgv, e, 4)

        'variables that hold original values before changes
        editID = AidFunctions.getSelectedFromDgv(editDgv, e, 0)
    ...
    Private Sub updateBtn_Click(sender As Object, e As EventArgs) Handles updateBtn.Click
        ...
        If (AidFunctions.areEdit(editUserNameTb, editUser, editID, "userName")) Then editDone = True
        If (AidFunctions.areEdit(editPasswordTb, editPass, editID, "password")) Then editDone = True
        If (AidFunctions.areEdit(editWebsiteTb, editWeb, editID, "websiteName")) Then editDone = True
        If (AidFunctions.areEdit(editLinkTb, editLink, editID, "link")) Then editDone = True
    ...
    Private Sub delShwPassCb_CheckedChanged(sender As Object, e As EventArgs) Handles delShwPassCb.CheckedChanged
        AidFunctions.showPasswordCb(delShwPassCb, delPasswordTb)
    End Sub
    ...
    Private Sub delByUserRb_CheckedChanged(sender As Object, e As EventArgs) Handles delByUserRb.CheckedChanged
        Try
            AidFunctions.fillListBox(dataTblUserName, delAccLb, "userName")
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub delDgv_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles delDgv.RowEnter
        ...
        delID = AidFunctions.getSelectedFromDgv(delDgv, e, 0)
        delUserNameTb.Text = AidFunctions.getSelectedFromDgv(delDgv, e, 1)
        delPasswordTb.Text = AidFunctions.getSelectedFromDgv(delDgv, e, 2)
        delWebsiteTb.Text = AidFunctions.getSelectedFromDgv(delDgv, e, 3)
        delLinkTb.Text = AidFunctions.getSelectedFromDgv(delDgv, e, 4)
    End Sub
